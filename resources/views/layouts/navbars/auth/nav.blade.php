            ...
            Builder</a>
                ...
                <li class="flex items-center">
                    <div class="flex items-center space-x-4">
                        <img type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" y
                            class="w-10 h-10 rounded-full" src="https://i.pravatar.cc/150?u=6" alt="">
                    </div>
                    <!-- Dropdown menu -->
                    <div id="userDropdown"
